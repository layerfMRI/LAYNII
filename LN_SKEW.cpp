...
int show_help( void )
{
   printf(
      ...
      "\n"
      "    This is very helpful for artifact hunting E.g. Ghosting \n"
      "\n"
      "\n"
      "    basic usage: LN_SKEW -timeseries Nulled_intemp.nii  \n"
      "\n"
      "\n"
      "\n"
      "    options:\n"
...
if ( nim_file_1i->datatype == NIFTI_TYPE_INT16 ) {
  short  *nim_file_1i_data = (short *) nim_file_1i->data;
    ...
    cout << " calculating skew, kurtosis and autocorrel = " << shift << endl ; 
  ...
  cout << "writing Skew file as = " << outfilename_1.c_str() << endl; // finfi is: char *
  ...
  cout << "writing Kurtosis file as = " << outfilename_2.c_str() << endl; // finfi is: char *
  ...
  cout << "writing Kurtosis file as = " << outfilename_3.c_str() << endl; // finfi is: char *
  ...
  cout << "writing Overal correlation file as = " << outfilename_4.c_str() << endl; // finfi is: char *
  const char  *fout_4=outfilename_4.c_str() ;
  if( nifti_set_filenames(conc_file, fout_4 , 1, 1) ) return 1;
