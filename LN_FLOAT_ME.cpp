...
{
   printf(
      "LN_FLAOAT_ME: short convert dataset to FLOAT32, e.g. \n"
      "\n"
      "    This program convert any nii file in FLOATs ,\n"
      "    This is very useful when you want the reduce the file size after ANTS was applied and \n"
      "    that have a small dynamic range.\n"
      "\n"
      "    basic usage: LN_FLOAT_ME -input data_file.nii -output output_filename.nii \n"
      "\n"
      "\n"
      "\n"
      "       -help             : show this help\n"
