...
# Dependencies
g++    -c -o obj/nifti2_io.o nifti2_io.cpp -O2
g++    -c -o obj/nifticdf.o nifticdf.cpp -O2
g++    -c -o obj/znzlib.o znzlib.cpp -O2
g++    -c -o obj/laynii_lib.o laynii_lib.cpp -O2
...
g++    -c -o obj/LN_3DGROW_LAYERS.o LN_3DGROW_LAYERS.cpp -O2
g++  -o LN_3DGROW_LAYERS -Wall -pedantic -DHAVE_ZLIB -I. -O2  obj/LN_3DGROW_LAYERS.o obj/nifti2_io.o obj/nifticdf.o obj/znzlib.o obj/laynii_lib.o
