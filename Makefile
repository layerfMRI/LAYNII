...
LAYNII2	= LN2_LAYERS LN2_COLUMNS
...
LN2_FLATTEN:
	$(CC) $(CFLAGS) -o LN2_FLATTEN src/LN2_FLATTEN.cpp $(LIBRARIES) $(LFLAGS)

LN2_DIFFUSE:
	$(CC) $(CFLAGS) -o LN2_DIFFUSE src/LN2_DIFFUSE.cpp $(LIBRARIES) $(LFLAGS)

LN2_COLTRIAN:
	$(CC) $(CFLAGS) -o LN2_COLTRIAN src/LN2_COLTRIAN.cpp $(LIBRARIES) $(LFLAGS)

LN2_TRILATERATE:
	$(CC) $(CFLAGS) -o LN2_TRILATERATE src/LN2_TRILATERATE.cpp $(LIBRARIES) $(LFLAGS)
