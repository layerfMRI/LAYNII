...
int main(int argc, char * argv[]) {
    ...
    int size_x = nii_input1->nx;
    int size_y = nii_input1->ny;
    int size_z = nii_input1->nz;
    int size_t = nii_input1->nt;
    int nr_voxels = nii_input1->nvox;
    int nx = nii_input1->nx;
    int nxy = nii_input1->nx * nii_input1->ny;
    int nxyz = nii_input1->nx * nii_input1->ny * nii_input1->nz;
    ...
    nifti_image* nii_landmark = copy_nifti_as_int32(nii_input1);
