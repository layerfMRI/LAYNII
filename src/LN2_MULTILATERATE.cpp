...
int show_help(void) {
    ...
    "\n"
    "Usage:\n"
    "    LN2_MULTILATERATE -rim rim.nii -control_points rim_midgm_points.nii -radius 10\n"
    "\n"
    "Options:\n"
    "    -help           : Show this help.\n"
    ...
    "                      (I) One voxel labeled with value '2' indicates the\n"
    "                      origin/centroid of the region of interest.\n"
    "                      (II) Four voxels labeled with values '3, 4, 5, 6'.\n"
    "                      In case (I), you need to use '-radius' parameter.\n"
    "                      In case (II), voxels labeled with 3 & 4 determine\n"
    "                      the first axis and the voxels labeled with 5 & 6\n"
