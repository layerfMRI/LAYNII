...
// WORKS in PROGRES
// ToDO think about what to do with time series data. E.g. carpet plot: https://github.com/layerfMRI/repository/tree/master/Layer_me
...
int show_help(void) {
    printf(
    "LN2_PROFILE: generates layer profiles from any 3D nii file based on defined layer masks\n"
    "            It averages all the signal intensities of each layer and write it out as a 2d-plot \n"
    "            The ouput is a text file (table) \n"
    "            The first column refers to the layer number  \n"
    "            The second column refers to the mean signal in this layer  \n"
    "            The third column refers to the STDEV of the signal variance acorss all voxels in this layer \n"
    "            The fourth column refers to number of voxels per layer \n"
    ...
    "\n"
    "Notes:\n"
    "    -The averaging is done across all voxels in the layer, independent of their value.\n"
...
int main(int argc, char*  argv[]) {
    ...
    // ========================================================================
    // Looking how many layers we have and allocating the arrays accordingly
    // ========================================================================
    int nr_layers = 0;
    ...
    // ========================================================================
    // Looking how many voxels we have per layer
    // ========================================================================
    for(int i = 0; i < nr_layers; i++) {
    ...
    // ========================================================================
    // going through layers MAIN loop
    // ========================================================================
    ...
    // ========================================================================
    // writing layer profiles to terminal
    // ========================================================================
    if (mode_debug){
        for(int i = 0; i < nr_layers; i++) {
    ...
    // ========================================================================
    // writing layer profiles to text file with the rigth file name
    // ========================================================================
    
    //namaging file name, path and extension
    string path_out;
    ...
    // ========================================================================
    // ploting in terminal, using ASKII here to avoid dependecies to specific terminal types
    // ========================================================================
...
if (mode_plot){
    ...
    cout << endl<< endl;
    int termwdth = 80; // terminal width. of course this can be set automatically, but then it will get dependencies of operating system
    int termhght = 20;  // terminnal hight
