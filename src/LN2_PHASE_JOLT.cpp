...
int show_help(void) {
    ...
    "\n"
    "Usage:\n"
    "    LN2_PHASE_JOLT -input Sphase_t-001.nii.gz -int13\n"
    "    LN2_PHASE_JOLT -input Sphase_t-001.nii.gz -int13 -2D\n"
    "    LN2_PHASE_JOLT -input Sphase_t-001.nii.gz -int13 -2D -phase_jump\n"
    "\n"
    "Options:\n"
    "    -help           : Show this help.\n"
