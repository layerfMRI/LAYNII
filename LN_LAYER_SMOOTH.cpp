...
int show_help(void) {
    ...
    "\n"
    "    This program smooths data within layer or columns. \n"
    "    In order to avoid smoothing across masks, a crawler smooths \n"
    "    only across connected voxels.\n"
    "\n"
    "    Basic usage:\n"
    ...
    "\n"
    "        -help       : Show this help.\n"
    "        -layer_file : Nifti (.nii) file that contains layer or \n"
    "                      column masks.\n"
    ...
    "        -twodim     : Optional argument to smooth only in 2D. \n"
    "        -mask       : Optional argument to mask activity outside of \n"
    "                       layers. \n"
    "        -sulctouch  : Optional argument that does not allow \n"
    "                      smoothing across sucli. This is necessary, \n"
    "                      when you do very heavy smoothing well bevond \n"
    "                      the spatial scale of the cortical thickness, \n"
    "                      or heavy cuvature. It will make things things \n"
    "                      slower. Note, that this is best done with not \n"
    "                      too many layers. Otherwise a single layer has \n"
    "                      holes and is not connected.\n"
    "\n");
    return 0;
}
