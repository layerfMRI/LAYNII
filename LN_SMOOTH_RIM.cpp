...
{
   printf(
      "LN_SMOOTH_RIM : This program corrected for errors in the manual drawn rim file"
      "\n"
      "   it removes foxles tht stick out of the smooth surfaces and filles in wholes \n"
      "\n"
      "    basic usage: LN_SMOOTH_RIM -rim rim.nii \n"
      "\n"
      "\n"
...
cout << " writing out " << endl; 
  ...
  cout << "writing as = " << outfilename_1.c_str() << endl; // finfi is: char *
