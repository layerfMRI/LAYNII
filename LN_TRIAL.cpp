...
{
   printf(
      "LN_TRIAL: This program is written to average trials of block design fMRI experiments\n"
      "\n"
      "    it assumes equi distant blocks with identical rest and activity periods\n"
      "\n"
      "\n"
      "    basic usage: LN_TRIAL -file file.nii -trialdur 12 \n"
      "\n"
      "\n"
      "\n"
      "    options:\n"
...
//  string prefix_2 = "min_TR_" ;
 ...
 // string outfilename_2 = prefix_2+filename_1 ;
   ...
   cout << "writing as = " << outfilename_1.c_str() << endl ; //" and "<< outfilename_2.c_str() << endl; // finfi is: char *

  const char  *fout_1=outfilename_1.c_str() ;
  if( nifti_set_filenames(triav_file, fout_1 , 1, 1) ) return 1;
