...
../LN_GRADSMOOTH -gradfile lo_T1EPI.nii -input sc_VASO_stat.nii -FWHM 2 -within -selectivity 0.1
../LN_GROW_LAYERS -rim sc_rim.nii
../LN_INTPRO -image sc_UNI.nii -min -direction 2

../LN_LEAKY_LAYERS -rim sc_rim.nii
../LN_NOISEME -input lo_VASO_stat.nii
...
../LN_TRIAL -file lo_BOLD_intemp.nii -trialdur 12
